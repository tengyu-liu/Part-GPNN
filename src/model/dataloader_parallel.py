...
class DataLoader:
    def __init__(self, imageset, node_num, datadir=os.path.join(os.path.dirname(__file__), '../../data/feature_resnet_tengyu'), negative_suppression=False, n_jobs=16, inverse_weight=False):
