...
def extract_features(paths, imageset):
    ...
    for i_image, img_info in enumerate(image_list):
        ...
        """ TODO: 
        1. visualize det_boxes_all on images
        2. visualize human boxes on images
        3. add body parts to det_boxes_all and visualize to see if accurate
        """
        ...
        if feature_mode == 'vgg_roi':
            ...
            roi_features = np.empty((det_boxes_all.shape[0], 512, feature_size[0], feature_size[1]))
