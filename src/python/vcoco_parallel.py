...
def loss_fn(pred_adj_mat, adj_mat, pred_node_labels, node_labels, pred_node_roles, node_roles, human_nums, part_nums, obj_nums, part_human_id, mse_loss, multi_label_loss):
    ...
    for batch_i in range(batch_size):
        ...
        loss = weighted_loss(pred_node_labels_lifted[batch_i, :node_num, :].view(-1, action_class_num), node_labels[batch_i, :node_num, :].view(-1, action_class_num)) + weighted_loss(pred_adj_mat_lifted[batch_i, :node_num, :node_num], adj_mat[batch_i, :node_num, :node_num])
    ...
    loss += ce_loss(pred_node_roles_lifted.view(-1, roles_num), roles_indices.view(-1))
...
def main(args):
    ...
    edge_features, node_features, part_human_id, adj_mat, node_labels, node_roles, obj_boxes, part_boxes, human_boxes, img_id, img_name, human_num, part_num, obj_num, obj_classes, part_classes = training_set[0]
